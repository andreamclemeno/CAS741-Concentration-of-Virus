...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-1}: Expected Input
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-2}: Invalid Input: $N_{o}$
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-3}: Invalid Input: $N_{t}$
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-4}: Invalid Inputs: $N_{o}$, $N_{t}$
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-5}: Invalid Input: $t_{t}$
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-6}: Invalid Input: $t_{p}$
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-7}: Invalid Inputs: $t_{t}$, $t_{p}$
...
\item{T-}\refstepcounter{tinnum}\thetinnum\label{T-8}: Expected Input
